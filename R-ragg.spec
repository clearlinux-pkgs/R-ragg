...
Version  : 1.2.2
Release  : 23
URL      : https://cran.r-project.org/src/contrib/ragg_1.2.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/ragg_1.2.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645466800
