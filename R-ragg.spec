...
Version  : 0.4.1
Release  : 2
URL      : https://cran.r-project.org/src/contrib/ragg_0.4.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/ragg_0.4.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610468645
